    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://sample-app-du.sentry.io/issues/?project=4510193934336000">Issues Page</a>.
